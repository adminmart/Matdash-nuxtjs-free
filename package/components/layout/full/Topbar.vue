...
const items = [
  ...
  { text: "Templates", icon: GiftIcon, url: "https://adminmart.com/" },
  {
    text: "Hire Us",
    icon: BriefcaseIcon,
...
const buy_link = [
  {
    ...
    url: "https://adminmart.com/product/matdash-vuetify-nuxt-js-admin-template/?ref=56#product-price-section",
  },
  {
    title: "Buy Bootstrap Version",
    url: "https://adminmart.com/product/matdash-bootstrap-5-admin-dashboard-template/?ref=56#product-price-section",
  },
  {
    title: "Buy Angular Version",
    url: "https://adminmart.com/product/matdash-material-angular-dashboard-template/?ref=56#product-price-section",
  },
  {
    title: "Buy Vuejs Version",
    url: "https://adminmart.com/product/matdash-vuejs-admin-dashboard/?ref=56#product-price-section",
  },
  {
    title: "Buy Reactjs Version",
    url: "https://adminmart.com/product/matdash-tailwind-react-admin-template/?ref=56#product-price-section",
  },
  {
    title: "Buy Nextjs Version",
    url: "https://adminmart.com/product/matdash-next-js-admin-dashboard-template/?ref=56#product-price-section",
  },
];
</script>
<template>
  <div class="feature-topbar w-full pa-4 bg-grey200 w-100">
    <div
    ...
    >
      <div class="d-flex align-center ga-10">
        <a href="https://adminmart.com/" target="_blank">
          <img src="/images/logos/logo-adminmart.svg"
        /></a>
      ...
      <div class="d-flex flex-md-row flex-column align-center ga-4">
        <h5 class="text-h5">Check Matdash Premium Version</h5>
        <div class="d-flex ga-md-4 ga-2">
          <v-menu>
            ...
            <v-list density="compact" elevation="10">
              ...
              >
                <v-list-item-title
                  class="d-flex align-center ga-2 text-subtitle-1"
                >
